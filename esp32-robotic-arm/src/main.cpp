...
// (pasta data/) pelo LittleFS. O protocolo com o navegador continua em
// GRAUS (a interface web não muda) — a conversão grau <-> passo acontece
// toda aqui dentro, usando a relação de redução/micropasso de cada junta.
//
